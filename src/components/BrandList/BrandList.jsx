        ...
        <div className='brandList'>
            ...
            <TableContainer component={Paper}>
                <Table aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            <StyledTableCell align='center'>Mã nhãn hiệu</StyledTableCell>
                            <StyledTableCell>Tên nhãn hiệu</StyledTableCell>
                    ...
                    <TableBody>
                        {data.map((row) => (
                            <StyledTableRow key={row.name}>
                                <StyledTableCell align="center">{row.manh}</StyledTableCell>
                                <StyledTableCell>{row.tennh}</StyledTableCell>
